        ...
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-body">
                <div class="alert alert-info bg-light border-info">
                    ...
                    <p class="mb-0">Detail lengkap data transaksi penjualan</p>
                </div>
                
                <!-- Customer Info Card -->
                <div class="card mb-4 shadow-sm">
                    <div class="card-header bg-light">
                        <h6 class="mb-0"><i class="fas fa-user mr-2"></i>Informasi Pelanggan</h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-light">
                        <h6 class="mb-0"><i class="fas fa-shopping-cart mr-2"></i>Detail Barang</h6>
                    </div>
                    ...
                    <body>
                        <div class="invoice-container">
                            ...
                            <div class="footer">
                                ...
                                <p style="color: #999; font-size: 14px;">Invoice ini adalah bukti pembayaran yang sah</p>
                            </div>
                        </div>
                    </body>
                    </html>
