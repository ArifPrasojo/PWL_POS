...
class DetailPenjualanController extends Controller
{
    ...
    public function list(Request $request){
        $detailpenjualans = DetailPenjualanModel::select('detail_id', 'penjualan_id', 'barang_id', 'harga', 'jumlah')->with('penjualan', 'barang');
    ...
    public function export_excel()
    {
        ...
        $detailpenjualan = DetailPenjualanModel::select('penjualan_id', 'barang_id', 'harga', 'jumlah')
