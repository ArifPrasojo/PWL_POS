...
class PenjualanController extends Controller
{
    ...
    public function show_ajax(string $id){
        ...
        // $penjualan_detail = DetailPenjualanModel::where('penjualan_id', $id)->select('penjualan_id', 'barang_id', 'harga', 'jumlah')->get();
        $penjualan_detail = DetailPenjualanModel::where('penjualan_id', $id)->select('penjualan_id', 'barang_id', 'harga', 'jumlah')->get();
        $total_harga = DetailPenjualanModel::where('penjualan_id', $id)->select(DB::raw('SUM(harga * jumlah) as total_harga'))->first()->total_harga;
